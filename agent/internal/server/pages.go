...
function renderAttachments(){
  ...
  $('attachmentSummary').textContent = (i18n.attachments || 'Attachments') + ' (' + state.attachments.length + ')';
  list.innerHTML = '';
